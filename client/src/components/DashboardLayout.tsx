...
import { LayoutDashboard, LogOut, PanelLeft, Calendar, Users, FileText, CheckCircle, AlertCircle, MessageSquare } from "lucide-react";
...
const allMenuItems = [
  ...
  { icon: CheckCircle, label: "Deliverables", path: "/admin/deliverables", roles: ["admin"] },
  { icon: AlertCircle, label: "RFI Requests", path: "/admin/rfi", roles: ["admin"] },
  { icon: MessageSquare, label: "Information Requests", path: "/scheduler/rfi", roles: ["client_scheduler"] },
];
...
export default function DashboardLayout({
  ...
  const [defaultSidebarOpen] = useState(() => {
    const cookieValue = getCookie(SIDEBAR_STATE_KEY);
    return cookieValue === 'true' || cookieValue === null; // Default to open if no cookie
  });
...
function DashboardLayoutContent({
  ...
  const menuItems = getMenuItemsForRole(user?.role || 'admin');
